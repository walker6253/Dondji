...
(function() {
  ...
  const translations = {
    ...
    'visitorTodaySuffix': '人',
      ...
      'toolboxReset': '重置设备',
      'toolboxReboot': '重启设备',
      'toolboxDowngrade': 'UVK1(8)恢复原厂教程',
      'clickDetail': '点击查看详情',
      ...
      'downgradeTitle': '🔧 UVK1(8)恢复原厂教程',
      'downgradeSubtitle': '用叮咚鸡菜单「恢复出厂 → 原厂(OEM)」擦除写频密钥后，再用官方 CPS 刷回原厂固件：',
      'downgradeStep1Title': '解锁全部菜单：',
      'downgradeStep1Content': '关机后，同时按住 PTT 与紧挨其下方的侧键开机，进入完整菜单。',
      'downgradeStep2Title': '执行「原厂」恢复：',
      'downgradeStep2Content': '打开「其它」→「恢复出厂」→ 选择「原厂」(OEM) → 确认。',
      'downgradeStep3Title': '关机：',
      'downgradeStep3Content': '屏幕显示「请关机」后关机（英文界面为 PWR OFF）。',
      'downgradeStep4Title': '官方 CPS 刷原厂固件：',
      'downgradeStep4Content': '用官方写频软件：设备 → 升级程序 → 升级。原厂固件可在本页应急工具箱下载。',
      'downgradeNote': '说明：该操作会擦除含 AES 写频密钥的 Flash 区，避免刷回官方后 CPS 要密码；校准数据保留。',
      'downgradeCredit': '感谢@sfyzzw提供思路',
      'toolboxStockFw': 'K1 官方中文固件',
